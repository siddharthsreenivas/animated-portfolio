...
const Page2 = () => {
  ...
  return (
    <div id="section2" className="bg-white text-center p-14 mt-4  text-black">
      <h3 className="text-gray-400 text-2xl font-[font3]">
        © anzo.studio 2024 | designed and developed
      </h3>
      <div className="rotateText mt-40">
        <h1 className="text-[42vw] text-black font-[font4] leading-[35vw]">
          IMPACTFUL
        </h1>
      </div>
      ...
      <div className="h-[2px] w-1/3 mx-auto mt-20 bg-black">
